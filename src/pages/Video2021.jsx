...
const Video2021 = () => {
  return (
    <>
      <Helmet>
        <title>Raid de Noël - Vidéo 2021</title>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 pt-20">
          ...
          >
            ...
            <p className="text-sm md:text-lg text-gray-600 text-center">
              Retour en images sur le Raid de Noël 2021
            </p>
          </motion.div>
          <div className="aspect-video w-full rounded-lg overflow-hidden shadow-lg">
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/nCYx1FHRNps?si=8kWs0uuehLBRspOx"
              title="Vidéo Raid de Noël 2021"
              frameBorder="0"
